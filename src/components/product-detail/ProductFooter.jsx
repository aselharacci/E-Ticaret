	...
	return (
		<section className="flex flex-col w-[90vw] mx-auto my-20 gap-10 font-[Montserrat] text-[#252B42] lg:w-[1056px]">
			<div className="mx-auto flex justify-center gap-10 items-center md:w-[30vw] ">
				<button
					className={`text-sm text-[#737373] cursor-pointer ${activeTab === "description"
				...
				<button
					className={`text-sm text-[#737373] cursor-pointer ${activeTab === "additionalInformation"
							? `font-semibold underline`
							: `font-bold`
						}`}
				...
				<button
					className={`text-sm text-[#737373] cursor-pointer ${activeTab === "review" ? `font-semibold underline` : `font-bold`
						}`}
