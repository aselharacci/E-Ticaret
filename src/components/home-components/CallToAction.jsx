...
const CallToAction = () => {
  return (
    ...
    >
      ...
      <div
        className="order-2 lg:order-1 w-full lg:w-[704px] lg:h-full flex justify-center items-end relative lg:absolute lg:left-0 lg:top-0 lg:bottom-0 lg:right-auto z-0"
      >
        <img
          src="/c2a.png"
          alt="asian-woman-man-with-winter-clothes"
          className="block w-full lg:w-[725px] lg:h-[774px] object-cover select-none pointer-events-none lg:absolute"
          draggable={false}
        />
      </div>
      {/* Metin ve CTA */}
      <div
        className="order-1 md:order-2 flex flex-col justify-center md:items-start items-centerorder-1 lg:order-2 flex flex-col justify-center lg:items-start items-center px-4 lg:px-0 py-14 lg:py-0 lg:pr-16 lg:pl-0 w-full lg:w-[573px] z-10px-4 md:px-0 py-14 md:py-0 md:pr-16 md:pl-0 w-full md:w-[573px] z-10"
      >
        {/* Tag */}
        <div className="mb-3">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-[25px] md:gap-[10px] w-[165px] md:w-[339px] h-[129px] md:h-[52px]">
          <button
            className="font-montserrat font-bold text-[14px] leading-[22px] tracking-[0.2px] text-white rounded-[5px] px-[40px] h-[52px] bg-[#23A6F0] md:bg-[#2DC071] transition hover:bg-[#1e8bd4] md:hover:bg-[#27a15e] flex items-center justify-center"
          >
            BUY NOW
          </button>
          <button
